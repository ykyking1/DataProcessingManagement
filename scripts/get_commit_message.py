...
def _build_commit_message(
    ...
    published = assets.get("published_auair_dataset")
    if published is None:
        raise CommitMessageError(
            "Run başarılı olsa da published_auair_dataset kaydı bulunamadı; "
    ...
    validation = assets.get("validated_auair_batch") or {}
